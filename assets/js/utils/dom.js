...
function disableEl(...elements) { [].concat(...elements).forEach(el => { el.disabled = true; }); }

function enableEl(...elements) { [].concat(...elements).forEach(el => { el.disabled = false; }); }
...
export { $, $$, showEl, hideEl, toggleEl, clearEl, removeEl, makeEl, disableEl, enableEl, insertBefore, onLeftClick, whenReady, escapeHtml, escapeCss, findFirstTextNode };
